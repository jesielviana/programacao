...
The idea behind `async.series` is actually quite simple. The trick is to call the asynchronous functions *recursively*. Here's a simple implementation that doesn't handle errors:
